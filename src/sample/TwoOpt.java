...
public class TwoOpt {
	public static ArrayList<Point2D> alternate(ArrayList<Point2D> cities, int iIn, int jIn) {
		...
		//System.out.println("Starting out with best dist = " + bestDist);
		while (swaps != 0) { // loop until no improvements are made.
			...
			//ArrayList<ArrayList<Point2D>> improvements = new ArrayList<ArrayList<Point2D>> ();
			...
			//System.out.println("Best tour for iteration " + iterations + " = " + bestDist);
			iterations++;
		}
